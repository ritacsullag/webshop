...
create table product_aud (price float(53), rev integer not null, revtype smallint, category_id bigint, id bigint not null, name varchar(255), primary key (rev, id));
