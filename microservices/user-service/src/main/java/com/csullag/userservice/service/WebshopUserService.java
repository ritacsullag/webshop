...
public class WebshopUserService {
    ...
    public WebshopUser createWebshopUser(WebshopUser webshopUser) throws AlreadyUsedException {
        if (webshopUserRepository.existsByUsername(webshopUser.getUsername())) {
            throw new AlreadyUsedException("Username already exist");
        }
    ...
    public String login(LoginDto loginDto) {
        ...
        if (loginDto.getFacebookToken().isEmpty()) {
